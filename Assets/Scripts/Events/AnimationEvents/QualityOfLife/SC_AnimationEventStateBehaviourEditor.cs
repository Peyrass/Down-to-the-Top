...
[UnityEditor.CustomEditor(typeof(SC_AnimationEventStateBehaviour))]
public class SC_AnimationEventStateBehaviourEditor : Editor {
    Motion previewClip;
    float previewTime;
    bool isPreviewing;
    ...
    public override void OnInspectorGUI() {
        ...
        SC_AnimationEventStateBehaviour stateBehaviour = (SC_AnimationEventStateBehaviour) target;
    ...
    void PreviewAnimationClip(SC_AnimationEventStateBehaviour stateBehaviour) {
    ...
    void SampleBlendTreeAnimation(SC_AnimationEventStateBehaviour stateBehaviour, float normalizedTime) {
    ...
    ChildAnimatorState FindMatchingState(AnimatorStateMachine stateMachine, SC_AnimationEventStateBehaviour stateBehaviour) {
    ...
    bool Validate(SC_AnimationEventStateBehaviour stateBehaviour, out string errorMessage) {
